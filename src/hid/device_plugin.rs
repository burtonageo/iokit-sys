...
use cf::{Boolean, CFArrayRef, CFDictionaryRef, CFIndex, CFStringRef, CFTypeRef, CFUUIDGetConstantUUIDWithBytes, CFUUIDRef,
         IUNKNOWN_C_GUTS};
use core::ptr;
...
pub unsafe fn kIOHIDDeviceFactoryID() -> CFUUIDRef {
